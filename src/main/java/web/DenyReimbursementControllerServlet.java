...
@WebServlet(urlPatterns = {"/deny-reimbursement"})
public class DenyReimbursementControllerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (currentUser != null) {
            reimbursementRepository.denyReimbursement(Integer.parseInt(id));
