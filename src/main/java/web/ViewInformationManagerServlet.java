...
@WebServlet(urlPatterns = {"/view-information-manager", "/update-information-manager"})
public class ViewInformationManagerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (currentUser != null) {
            ...
            req.getRequestDispatcher("manager-view-information.jsp").forward(req, resp);
        }
        else {
