...
@WebServlet(urlPatterns = {"/resolved-reimbursements"})
public class ResolvedReimbursementControllerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (currentUser != null) {
            List<Reimbursement> resolvedReimbursements = reimbursementRepository.loadEmployeeResolvedReimbursements((Integer) session.getAttribute("employee-id"));
            req.setAttribute("resolved-reimbursement-list", resolvedReimbursements);
            req.getRequestDispatcher("resolved-reimbursements-employee.jsp").forward(req, resp);
        } else {
