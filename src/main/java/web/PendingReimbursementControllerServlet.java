...
@WebServlet(urlPatterns = {"/pending-reimbursements"})
public class PendingReimbursementControllerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (currentUser != null) {
            List<Reimbursement> pendingReimbursements = reimbursementRepository.loadEmployeePendingReimbursements((Integer) session.getAttribute("employee-id"));
            req.setAttribute("pending-reimbursement-list", pendingReimbursements);
            req.getRequestDispatcher("pending-reimbursements-employee.jsp").forward(req, resp);
        } else {
